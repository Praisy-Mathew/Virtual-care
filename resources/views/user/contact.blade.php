  ...
  <section id="contact" class="contact">
    <div class="container">
      ...
      <div class="section-title" style="margin-top:100px;">
        <h2> Contact Us </h2>
        <h5>We are here to assist you with any inquiries or
          concerns. Please reach out to us through any of the following methods.</h5>
      </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="info-box">
                <i class="bx bx-map"></i>
                <h3>Our Address</h3>
                <p>Virtual Care,A108 Adam Street, New York, NY 535022</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info-box mt-4">
                ...
                <h3>Email Us</h3>
                <p>info@virtualcareinfo.com<br>contact@Virtualcare.com</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info-box mt-4">
