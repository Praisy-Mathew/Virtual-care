  ...
  <section id="gallery" class="gallery">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <div class="col-lg-12">
        <h2 style="margin-top:100px; color: skyblue;">Paediatric Care</h2>
        <p><em><strong> Paediatric Department provides
            comprehensive virtual care for infants, children, and adolescents. From routine checkups to specialized treatments, we are dedicated to the health and well-being of your
            child.</strong></em></p>
        </div>
      </div>
    ...
    <div class="swiper-wrapper align-items-center">
        @foreach($galleries as $gallery)
            @if($gallery->department === 'Paediatric')
    ...
    <div class="swiper-pagination"></div>
      ...
      <!-- <div class="gallery-slider swiper">
        <div class="swiper-wrapper align-items-center">
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae2.png"><img src="assets/img/pae2.png" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae3.jpg"><img src="assets/img/pae3.jpg" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae4.j.jpg"><img src="assets/img/pae4.j.jpg" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae6..jpg"><img src="assets/img/pae6..jpg" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae7.jpg"><img src="assets/img/pae7.jpg" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae8.jpg"><img src="assets/img/pae8.jpg" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae9..jpg"><img src="assets/img/pae9..jpg" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="gallery-lightbox" href="assets/img/pae10.jpg"><img src="assets/img/pae10.jpg" class="img-fluid" alt=""></a></div>
        </div>
        <div class="swiper-pagination"></div>
      </div> -->
      <div class="row">
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="" style="border-color:skyblue; border-radius:10%; border-width:4px;">
            <div class="card-body text-center" style="margin-top: 15px;">
              <i class="fa fa-pills" style="font-size: 3rem; color:skyblue;"></i>
              <h5 class="card-title" style="color:skyblue">Vaccinations</h5>
              <p class="card-text"><strong><em >Immunizations to protect children from various infectious diseases.</em></strong></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="" style="border-color:skyblue; border-radius:10%; border-width:4px;">
            <div class="card-body text-center" style="margin-top:5px;">
              <i class="bi bi-person-check" style="font-size: 3rem; color: skyblue;"></i>
              <h5 class="card-title" style="color: skyblue;">routine check-ups</h5>
              <p class="card-text"><strong><em>Regular health assessments to monitor and maintain overall well-being.</em></strong></p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="" style="border-color:skyblue; border-radius:10%; border-width:4px;">
            <div class="card-body text-center" style="margin-top: 20px;">
              <i class="fa fa-baby" style="font-size: 3rem; color: skyblue;"></i>
              <h5 class="card-title" style="color: skyblue;">specialized paediatric treatments</h5>
              <p class="card-text"><strong><em>Advanced medical care tailored to address specific health needs of children.</em></strong></p>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <form action="{{ route('admin.appointments.appointmentsStore') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="department" name="department" required>
                                ...
                                <option value="paediatric" selected>Paediatric</option>
  ...
  <script>
    $(document).ready(function() {
      $('#appointmentModal').on('show.bs.modal', function (event) {
        var modal = $(this);
        modal.find('.modal-body #department').val('paediatric'); // Set the department to Emergency
      });
    });
  </script>
</body>
