    ...
    <div class="container" data-aos="fade-up">
      <div class="section-title">
        ...
        <p>Please read these terms of service carefully
            before using our website and services.</p>
      </div>
    </div>
    <main id="main">
      ...
      <section id="featured-services" class="featured-services">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-4  mb-5 mb-lg-0">
              <div class="icon-box-1" data-aos="fade-up" data-aos-delay="100">
                <h4 class="title" style="text-align: center;"><a href=>Use of Services</a></h4>
                <p class="description">By using our services, you agree to comply with these terms
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box-1" data-aos="" data-aos-delay="200">
                <h4 class="title" style="text-align: center;"><a href="">User Responsibilities</a></h4>
                <p class="description">You are responsible for providing accurate
                    information and keeping your account secure.</p>
              </div>
            </div>
  
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
              <div class="icon-box-1" data-aos="fade-up" data-aos-delay="300">
                <h4 class="title" style="text-align: center;"><a href="">Limitation of Liability</a></h4>
                <p class="description">Virtual Care is not liable for any damages arising
                    from the use of our services beyond the extent permitted by law.</p>
              </div>
            </div>
        ...
        <div>
          <p style="text-align: center;"><strong><em>If you have any questions about our terms of service, please contact
            us at<span style="color: skyblue;"> virtualcareinfo@gmail.com</span></em></strong></p>
        </div>
